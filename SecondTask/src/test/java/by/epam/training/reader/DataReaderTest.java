...
public class DataReaderTest {
    ...
    public void readTextFromFileTest() throws DataReaderException {
        String expectedText = "    It has survived - not only (five) centuries, but also the leap into 13<<2 electronic typesetting, remaining 3>>5 essentially ~6&9|(3&4) unchanged… It was popularised in the 5|(1&2&(3|(4&(8^5|6&47)|3)|2)|1) with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.\r\n" +
                ...
                "    Bye.";
        String actualText = dataReader.readTextFromFile(TEST_PATH);
